...
HillSkillsButton navigateButton(String routeName,
    {UserAccount account,
    String text = 'Next',
  ...
  void registrationNavigation() {
    if (account == null)
      ...
      locator<NavigationService>().navigateWithParameters(routeName, account);
  }

  return HillSkillsButton(
    text,
...
// Prodfuces a list of clickable chips from provided HillSkillsTags object 
List<Widget> chipListBuilder({
  @required HillSkillsTags tags,
...
class HillSkillsExpansion extends StatelessWidget {
  final String title;
  ...
  HillSkillsExpansion({@required this.title,
    ...
    return Theme(
      ...
      accentColor: currentTheme.isDarkModeEnabled
        ? Colors.grey[300]
        : Colors.grey[700]
      ),
      child: ExpansionTile(
...
class HillSkillsRefreshIndicator extends RefreshIndicator {
  HillSkillsRefreshIndicator({child, onRefresh}) :
    super(child: child,
      onRefresh: onRefresh,
