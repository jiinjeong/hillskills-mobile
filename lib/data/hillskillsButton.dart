...
class HillSkillsButton extends StatefulWidget {
  ...
  HillSkillsButton(this.str, this.action,
      {this.parameter,
      this.bold = false,
      this.invertColors = false,
      this.validator});

    HillSkillsButtonState createState() => HillSkillsButtonState();
}

class HillSkillsButtonState extends State<HillSkillsButton> {
